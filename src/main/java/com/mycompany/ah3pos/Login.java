...
if (jusuario.getText().equals ("admin") && jPassword.getText () .equals ("admin")) {
            ...
            JOptionPane.showMessageDialog(this, "Campo de contraseña y/o usuario estáan vacios");
                jusuario.setFocusable(true);
        }
            ...
            for (Usuario perfil : Usuario.usuario){
                if (jusuario.getText().equals (perfil.getNombre())&& jPassword.getText () .equals (perfil.getContraseña())) {
